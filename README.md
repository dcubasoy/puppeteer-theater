...
Normally, when working with puppeteer, you will find yourself repeatedly calling-  `waitForNavigation().` What if there were a way to simply provide the bot what it should see (on the page), and instruct it what to do when suchTheater is matching scenes with the screen (literally), and consequently, it doesn't require any such calls. This is the principal dilemna theater solves. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwODMyOTAwMzMsLTE3MDg4ODk2NjUsMj
A5NTEzMzU3Ml19
-->