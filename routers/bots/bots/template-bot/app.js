        ...
        <div className='container'>
          ...
          <form className="form-horizontal">
            <div className="form-group">
              <label htmlFor="sessionId" className="col-sm-2 control-label">Session</label>
              <div className="col-sm-10">
                <input value={this.state.sessionId} disabled={this.state.begun ? 'disabled': undefined} type="text" className="form-control" id="inputSessionId" placeholder="Session ID" onChange={e => this.setState({ session: e.target.value })} />
              </div>
            </div>
            <div className="form-group">
